...
const HibernationVegetableCultivation = () => {
  const mapList = new BackgroundMapList<HibernationVegetableCultivationMap>({
    title: TITLE,
  ...
  console.log({ mapList });
  return <VisualizationContainer title={TITLE} mapContent={mapList.renderMaps()} chartContent={mapList.renderFirstChart()} />;
};
