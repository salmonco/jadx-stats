...
export type Metrics = "ntrgn" | "ph" | "chlrn";
...
const useGroundwaterMetrics = (layerManager: LayerManager, ready: boolean, map: Map, selectedVisType?: string) => {
  const [selectedMetrics, setSelectedMetrics] = useState<Metrics>("ntrgn");
...
export default useGroundwaterMetrics;
